...
def get_data():
    ...
    row = ['team1', 'Run/10', 'Wicket/10 ', 'Run/20', 'Wicket/20 ', 'Run/30', 'Wicket/30 ', 'Run/40', 'Wicket/40 ',
           'Team1 Total Run', 'Team1 Total Wicket',
           'team2', 'Run/10', 'Wicket/10 ', 'Run/20', 'Wicket/20 ', 'Run/30', 'Wicket/30 ', 'Run/40', 'Wicket/40 ',
           'Team2 Total Run', 'Team2 Total Wicket'
           ]
    matrix= np.array(row)
    ...
    #         print("Second Innings:")
            ...
            row = [team1,team1Run[0],team1Wicket[0],team1Run[1],team1Wicket[1],team1Run[2],team1Wicket[2],team1Run[3],team1Wicket[3],
                   ...
                   team2,team2Run[0],team2Wicket[0],team2Run[1],team2Wicket[1],team2Run[2],team2Wicket[2],team2Run[3],team2Wicket[3],
    ...
    pd.DataFrame(matrix).to_csv("MatchInCosecutiveOvers.csv", sep=',')
